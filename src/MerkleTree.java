...
public class MerkleTree {
    ...
    public static void main(String[] args) {
        ...
        dataBlocks.add("Anuj Sinha");
        dataBlocks.add("20BCE2166");
        dataBlocks.add("VIT University");
        dataBlocks.add("Computer Science");
        System.out.println("The Strings are: \n\n1) Anuj Sinha \n2) 20BCE2166 \n3) VIT Univiersity \n4) Computer Science\n");
        System.out.println("\nThe hashes in level order by using level order traversal by the implementation of MERKLE TREE is: \n");
